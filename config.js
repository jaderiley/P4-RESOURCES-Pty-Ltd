...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "P4-RESOURCES (Pty) Ltd",
    phone:     "+27 84 662 5131",
    whatsapp:  "+27 84 662 5131",
    address:   "129 Italian Rd, Johannesburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "P4-RESOURCES (Pty) Ltd — Pest control in johannesburg",
    description: "P4-RESOURCES (Pty) Ltd provides professional pest control in Johannesburg. 2 Google reviews. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "P4-RESOURCES (Pty) Ltd provides effective pest control for homes and businesses across Johannesburg. Cockroaches, rodents, ants, termites — we identify the problem and treat it at the source.",
    ...
    band: {
      ...
      alt:   "P4-RESOURCES (Pty) Ltd team at work in Johannesburg",
